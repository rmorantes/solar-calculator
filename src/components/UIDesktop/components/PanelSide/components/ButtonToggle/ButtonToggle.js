...
// https://www.flaticon.com/free-icon/sun_169367
...
const Wrapper = styled.button`
  --dimension: 6rem;
  --dimensionHalf: calc(var(--dimension) / 2);
  height: var(--dimension);
  overflow: hidden;
  position: absolute;
  right: calc(var(--dimension) / -2);
  top: calc(50% - var(--dimensionHalf));
  width: var(--dimensionHalf);
`

const Sun = styled.svg`
  animation: ${rotate} 30s linear infinite;
  height: var(--dimension);
  left: calc(var(--dimensionHalf) * -1);
  position: absolute;
  top: 0;
  width: var(--dimension);
`
